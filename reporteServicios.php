...
$sqlUsuarios = "SELECT id_usuario, nombre, apellido FROM usuarios";
...
<head>
    ...
    <title>Reporte Mensual de Servicios</title>
...
<div class="content">
    <div class="container mt-4">
        <h1 class="text-center mb-4">Reporte Mensual de Servicios</h1>
            ...
            <div class="col-md-2">
                ...
                <select id="id_usuario" name="id_usuario" class="form-select">
                    ...
                    <?php foreach ($usuarios as $usuario): ?>
                        <option value="<?= $usuario['id_usuario'] ?>" <?= $usuario['id_usuario'] == $id_usuario ? 'selected' : '' ?>>
        ...
        <div class="d-flex justify-content-end mb-4">
            <a href="reportePDFServicios.php?mes=<?= $mes ?>&anio=<?= $anio ?>&id_usuario=<?= urlencode($id_usuario) ?>&estatus=<?= urlencode($estatus) ?>" class="btn btn-success">Generar PDF</a>
        </div>
                ...
                <?php if (!empty($servicios)): ?>
                    <?php foreach ($servicios as $servicio): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($servicio['usuario_nombre'] . ' ' . $servicio['usuario_apellido']) ?></td>
                            <td><?= htmlspecialchars($servicio['fecha_servicio']) ?></td>
                            <td><?= htmlspecialchars($servicio['hora_inicio']) ?></td>
                            <td><?= htmlspecialchars($servicio['hora_fin']) ?></td>
                            <td><?= $servicio['estatus'] ? 'Activo' : 'Inactivo' ?></td>
